...
- [x] T053 [P] [US4] Generator specs: creates initializer and migration, writes
...
- [x] T055 [P] [US4] Plain-interface specs: `Reeve.invoke` gives identical
...
- [x] T067 Clean-room provenance review before publishing (Constitution V): no proprietary
      names, schemas, or docs anywhere in the repo or its history
- [x] T068 CHANGELOG, semantic-version policy note, `rubygems_mfa_required` metadata (omitted from 0.0.1 to avoid blocking the name claim; a security gem should require MFA to publish), and the 0.1.0 release — push only on
